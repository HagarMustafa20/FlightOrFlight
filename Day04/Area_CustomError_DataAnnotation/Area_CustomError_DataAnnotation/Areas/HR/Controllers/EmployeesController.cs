...
using Area_CustomError_DataAnnotation.Data;
using Area_CustomError_DataAnnotation.Models;

namespace Area_CustomError_DataAnnotation.Areas.HR.Controllers
{
    public class EmployeesController : Controller
    {
        private Area_CustomError_DataAnnotationContext db = new Area_CustomError_DataAnnotationContext();
